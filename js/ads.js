...
var checkInternet = function () {
    if (navigator.onLine) {
        ...
        function allAds() {
            ...
            // document.getElementById("catname").innerHTML = "All ADs";
            let cardDeck = document.getElementById("cardDeck");
            cardDeck.innerHTML = "";

            // let currentUser = firebase.auth().currentUser;

            firebase.database().ref(`/adsAll/`).once('value', function (data) {
                ...
                data.forEach(function (childData) {
                    ...
                    // cardReport.setAttribute("href", "mailto:afzal_k1997@yahoo.com");
        ...
        function offlineAdsAll() {
            ...
            let cardDeck = document.getElementById("cardDeck");
            cardDeck.innerHTML = "";
            console.log('offline AdsAll')
            localforage.getItem('adsAll').then(data => {
